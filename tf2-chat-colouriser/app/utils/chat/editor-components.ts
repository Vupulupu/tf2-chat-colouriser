...
export class EditorComponents {
	...
	private _messageWidth: ShallowRef<HTMLElement>;
	...
	constructor(messageLabel: ShallowRef<HTMLLabelElement | null>,
	            ...
	            messageWidth: ShallowRef<HTMLElement | null>) {
		...
		if (!messageWidth) { this._nullElements.push("messageWidthSpan")}
		...
		this._messageWidth = (messageWidth as ShallowRef<HTMLElement>);
	}
	...
	get messageWidth(): HTMLElement {
		return this._messageWidth.value;
	}
